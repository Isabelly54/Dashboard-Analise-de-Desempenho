...
O objetivo desse repositório é mostrar a jornada de desenvolvimento de um projeto de **análise de dados**, desde da transformação dos dados de uma base bruta, até a construção de um Dashboard visual.
